...
// ── Component ─────────────────────────────────────────────────────────────────
const ContactPage = () => {
  useScrollTop(); // Fix: always scroll to top on mount
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* ── INFO CARDS ── */}
      {/* Fix 2: All 4 cards share ONE consistent ceylon-teal color scheme */}
          ...
          {INFO_CARDS.map((card, i) => (
            <FadeIn key={i} delay={i * 0.1} direction="up">
              <div className={`group relative rounded-2xl p-6
                ...
                <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-ceylon-400 to-ceylon-600
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
          ...
          <FadeIn delay={0.15} className="lg:col-span-2 space-y-6" direction="right">
            ...
            {/* Fix 3: Map — use Google Maps embed (always visible) */}
            <div className="rounded-3xl overflow-hidden shadow-md border border-gray-100 dark:border-gray-700 h-60 relative">
              ...
              <div className="absolute bottom-3 left-1/2 -translate-x-1/2 pointer-events-none">
                <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm rounded-xl
                                px-4 py-2 text-center shadow-lg border border-ceylon-100 dark:border-ceylon-900/30
                                whitespace-nowrap">
            ...
            {/* Fix 4: Real social icons — WhatsApp, Facebook, Instagram */}
            <div className="bg-ceylon-50 dark:bg-ceylon-900/20 rounded-3xl p-6
              ...
              <div className="flex gap-3">
                ...
                <a href="https://wa.me/94112345678" target="_blank" rel="noopener noreferrer"
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = '#25D366'; (e.currentTarget as HTMLElement).style.border = '1px solid #25D366'; (e.currentTarget as HTMLElement).style.boxShadow = '0 6px 20px rgba(37,211,102,0.40)'; }}
                  onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = ''; (e.currentTarget as HTMLElement).style.border = ''; (e.currentTarget as HTMLElement).style.boxShadow = ''; }}
                  title="WhatsApp">
                ...
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer"
                  className="group w-11 h-11 bg-white dark:bg-gray-800 rounded-xl flex items-center justify-center
                             shadow-sm border border-ceylon-100 dark:border-ceylon-900/40
                             hover:scale-110 hover:-translate-y-0.5 transition-all duration-300"
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = '#1877F2'; (e.currentTarget as HTMLElement).style.border = '1px solid #1877F2'; (e.currentTarget as HTMLElement).style.boxShadow = '0 6px 20px rgba(24,119,242,0.40)'; }}
                  onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = ''; (e.currentTarget as HTMLElement).style.border = ''; (e.currentTarget as HTMLElement).style.boxShadow = ''; }}
                  title="Facebook">
                  <svg className="w-5 h-5 text-gray-500 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer"
                  className="group w-11 h-11 bg-white dark:bg-gray-800 rounded-xl flex items-center justify-center
                             shadow-sm border border-ceylon-100 dark:border-ceylon-900/40
                             hover:scale-110 hover:-translate-y-0.5 transition-all duration-300"
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = 'linear-gradient(135deg,#833AB4,#FD1D1D,#F77737)'; (e.currentTarget as HTMLElement).style.border = '1px solid #FD1D1D'; (e.currentTarget as HTMLElement).style.boxShadow = '0 6px 20px rgba(253,29,29,0.35)'; }}
                  onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = ''; (e.currentTarget as HTMLElement).style.border = ''; (e.currentTarget as HTMLElement).style.boxShadow = ''; }}
                  title="Instagram">
                  <svg className="w-5 h-5 text-gray-500 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
